...
public class Semaphore {
	...
	public Semaphore(String pDebugName, int pInitialValue,int id)
	{
		mName = pDebugName;
		mValue = pInitialValue;
		mQueue = new LinkedList<NachosProcess>();
	...
	public void P() {
		...
		//We can do the Adding and consuming process variable here
		
		//Increase allocated in allocated MAP
		//decrease AVL array
		//Decrease need MAP
		
		JNachos.PCalled(JNachos.getCurrentProcess().getId(),this.id);
	...
	public void V() {
		...
		mValue++;
		JNachos.VCalled(JNachos.getCurrentProcess().getId(),this.id);
